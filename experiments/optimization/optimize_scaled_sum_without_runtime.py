...
# Third Party Library
import optuna
from egraph import Drawing, all_sources_bfs, crossing_edges
...
qm_names.remove("runtime")


def draw_and_measure_sscaled(
    pivots,
    iterations,
    eps,
    eg_graph,
    ...
    return params, quality_metrics, sscaled_quality_metrics, pos
...
def main():
    ...
    study_name = (
        f"{args.d}_ss_n-trials={args.n}_n-split={n_split}_without_runtime"
    )
